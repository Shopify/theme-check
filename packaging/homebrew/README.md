...
created. To do that manually, simply run `gem build <root>/theme-check.gemspec`.
...
* `THEME_CHECK_VERSION`: The current CLI version
* `THEME_CHECK_GEM_CHECKSUM`: The checksum of the gem
