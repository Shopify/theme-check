...
module PlatformosCheck
  class Packager
    ...
    def build_homebrew
      ...
      spec_contents = File.read(File.join(root_dir, 'platformos_check.base.rb'))
      spec_contents = spec_contents.gsub('PLATFORMOS_CHECK_VERSION', PlatformosCheck::VERSION)
      ...
      spec_contents = spec_contents.gsub('PLATFORMOS_CHECK_GEM_CHECKSUM', gem_checksum)
